...
?>
				<li class="media post pingback">
					<p><?php _e( 'Pingback:', 'odin' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( __( 'Edit', 'odin' ), '<span class="btn btn-edit-link">', '</span>' ); ?></p>
<?php
			break;
			default :
?>
					...
					<article id="div-comment-<?php comment_ID(); ?>" class="comment-body comment-author vcard">
						...
						<div class="media-body">
							<footer class="comment-meta">
								...
								<?php edit_comment_link( __( 'Edit', 'odin' ), '<span class="btn btn-edit-link">', '</span>' ); ?>
							...
							<div class="comment-metadata">
								<span class="btn btn-edit-link"><?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'Respond', 'odin' ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?></span>
